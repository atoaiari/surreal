...
# for i in {0..24}; do
#     $BLENDER_PATH/blender -b -t 12 --verbose 0 -P main_detangle.py -- --idx $i --orientations 16
# done
    
$BLENDER_PATH/blender -b --verbose 0 -P main_detangle.py -- --idx 0 --orientations 16